...
public class fca extends Concept
{
	...
	//Return the index of the object - 'objectName'
	...
	//Returns the properties that are common to all the objects in 'objectSet'
	...
	//Returns the objects that have all the properties in 'propSet' 
	...
	//Returns the set of objects that have a property
	...
	public static void main(String[] args) 
	{
		...
		try
		{
			...
			/*System.out.print("\nObjects\n");
			printArray( objects, noOfObjects );

			System.out.print("\nProperties\n");
			printArray( properties, noOfProperties );

			System.out.print("\nMatrix\n");
			printMatrix( matrix, noOfObjects, noOfProperties );*/
